...
# Vertical 9:16 variant · for lift door panels and vertical lobby screens
#
# Usage:
#   export PHAYA_API_KEY="pk_xxx"
#   export REFERENCE_URL="https://your-host/v3-diagram.png"
#   cd ads/condo-tv-loop-15s-9x16/
#   ./generate-i2i.sh
#
# Output:
#   clarity-condo-cut1.png · cut2.png · cut3.png (9:16 · 2K · 1152×2048)
#
# Constraints (per Phaya docs):
#   - input_urls: 1-5 URLs · JPEG/PNG/WEBP · ≤30MB each
#   - aspect_ratio="9:16" supports resolution="2K" and "4K"
...
echo "Aspect ratio:    $ASPECT_RATIO (vertical)"
...
echo ""
echo "═══════════════════════════════════════════"
echo "  ✓ Done · 3 i2i cuts ready (9:16 vertical)"
echo "═══════════════════════════════════════════"
echo ""
echo "Files:"
...
echo "  3. Animate: bash scripts/animate-condo-loop-9x16.sh (1080×1920 H.264)"
echo "  4. Add ฉสพ. license number overlay before publishing"
